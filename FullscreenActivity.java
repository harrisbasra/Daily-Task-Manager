package com.harrisbasra.iroutine;
...
import com.harrisbasra.iroutine.databinding.ActivityFullscreenBinding;
...
public class FullscreenActivity extends AppCompatActivity {
    ...
    public static String toTimeStr(Date time) {
        ...
        A = A+":";
        if(min<10){
        A = A+"0"+String.valueOf(min);
        }
        else{
        A = A+String.valueOf(min);
        }
        if(hour>=12)
        A = A+" PM";
        if(hour<12)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               Intent hi = new Intent(FullscreenActivity.this, Addprogress.class);
               startActivity(hi);
            }
        });
        //.................................................................
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i40083 = new Intent(FullscreenActivity.this, ViewReports.class);
                startActivity(i40083);
            }
        });
        //..................................................................
        Button fas = (Button) findViewById(R.id.button);
        fas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "iRoutine Feedbacks and Suggestions");
